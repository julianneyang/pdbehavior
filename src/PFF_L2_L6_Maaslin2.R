...
# Load metadata once
metadata <- read.csv(here("Analysis_Files/PFF/PFF_Microbiome/starting_files/PFF_Mapping.csv"), header=TRUE)
...
filter_and_save <- function(level, filter_column, filter_value) {
  data_path <- here(glue("Analysis_Files/PFF/PFF_Microbiome/differential_taxa/collapsed_ASV_tables/export_{level}_min10000_no_tax_PFF_ASV_table/feature-table.tsv"))
  ...
  output_file <- here(glue("Analysis_Files/PFF/PFF_Microbiome/differential_taxa/collapsed_ASV_tables/PFF_{level}_{filter_column}_{filter_value}.tsv"))
...
run_Maaslin2_genotype <- function(counts_filepath, metadata_filepath, subset_string, fixed_effects = c("Genotype"), random_effects=NULL) {
  ...
  readr::write_rds(Relative_Abundance, paste0(here("Analysis_Files/PFF/PFF_Microbiome/differential_taxa/collapsed_ASV_tables/"),"Relative_Abundance_", subset_string, ".RDS"))
  ...
  output_dir <- paste0(here("Analysis_Files/PFF/PFF_Microbiome/differential_taxa/collapsed_ASV_tables/"),subset_string, "_Maaslin2_", fixed_effects_label,"_1-",random_effects)
...
counts_filepaths <- c(
  here("Analysis_Files/PFF/PFF_Microbiome/differential_taxa/collapsed_ASV_tables/PFF_L6_Study_PFF_Baseline.tsv"),
  here("Analysis_Files/PFF/PFF_Microbiome/differential_taxa/collapsed_ASV_tables/PFF_L6_Study_PFF_Jejunum.tsv"),
  here("Analysis_Files/PFF/PFF_Microbiome/differential_taxa/collapsed_ASV_tables/PFF_L6_Study_PFF_Cecum.tsv"),
  here("Analysis_Files/PFF/PFF_Microbiome/differential_taxa/collapsed_ASV_tables/PFF_L6_Study_PFF_Colon.tsv"),
  here("Analysis_Files/PFF/PFF_Microbiome/differential_taxa/collapsed_ASV_tables/PFF_L6_Subset_Luminal_Colon.tsv")
)

subset_strings <- c("L6_Baseline", "L6_Jejunum", "L6_Cecum",
                    "L6_Colon", "L6_Luminal_Colon")
metadata_filepath <- here("Analysis_Files/PFF/PFF_Microbiome/starting_files/PFF_Mapping.csv")
...
lc_dat <-read.table(here("Analysis_Files/PFF/PFF_Microbiome/differential_taxa/collapsed_ASV_tables/L6_Luminal_Colon_Maaslin2_Sex_Genotype/significant_results.tsv"), header=TRUE)
...
lc_diff_taxa_het <- make_genus_level_taxa_dotplot(ASV_significant_results_dataset = lc_dat_het,
                                                  Relative_Abundance_filepath_rds = "Analysis_Files/PFF/PFF_Microbiome/differential_taxa/collapsed_ASV_tables/Relative_Abundance_L6_Luminal_Colon.RDS",
                                                  titlestring = "PFF Colonic Lumen (HET vs WT) (Genus ~ Sex + Genotype)",
                                                  genus_colors, qvalue = 0.25)
lc_diff_taxa_het

lc_diff_taxa_mut <- make_genus_level_taxa_dotplot(ASV_significant_results_dataset = lc_dat_mut,
                                                  Relative_Abundance_filepath_rds = "Analysis_Files/PFF/PFF_Microbiome/differential_taxa/collapsed_ASV_tables/Relative_Abundance_L6_Luminal_Colon.RDS",
                                                  titlestring = "PFF Colonic Lumen (MUT vs WT) (Genus ~ Sex + Genotype)",
                                                  genus_colors, qvalue = 0.25)
lc_diff_taxa_mut


lc_dat <-read.table(here("Analysis_Files/PFF/PFF_Microbiome/differential_taxa/collapsed_ASV_tables/L6_Luminal_Colon_Maaslin2_Sex_Study_Genotype/significant_results.tsv"), header=TRUE)
lc_dat_het <- lc_dat %>% filter(value=="HET") # 19 taxa
lc_dat_mut <- lc_dat %>% filter(value=="MUT")# 10 taxa
lc_diff_taxa_het_tri <- make_genus_level_taxa_dotplot(ASV_significant_results_dataset = lc_dat_het,
                                                  Relative_Abundance_filepath_rds = "Analysis_Files/PFF/PFF_Microbiome/differential_taxa/collapsed_ASV_tables/Relative_Abundance_L6_Luminal_Colon.RDS",
                                                  titlestring = "PFF Colonic Lumen (HET vs WT) (Genus ~ Sex + Site + Genotype)",
                                                  genus_colors, qvalue = 0.25)
lc_diff_taxa_het_tri

lc_diff_taxa_mut_tri <- make_genus_level_taxa_dotplot(ASV_significant_results_dataset = lc_dat_mut,
                                                  Relative_Abundance_filepath_rds = "Analysis_Files/PFF/PFF_Microbiome/differential_taxa/collapsed_ASV_tables/Relative_Abundance_L6_Luminal_Colon.RDS",
                                                  titlestring = "PFF Colonic Lumen (MUT vs WT) (Genus ~ Sex + Site + Genotype)",
                                                  genus_colors, qvalue = 0.25)
lc_diff_taxa_mut_tri
