...
## Ensure that MouseIDs are found in all 3 datasets --
...
df_motor <- merge(df_1, summary_rotarod, by="MouseID")
df_motor <- df_motor %>% select(c("MouseID","Time", "Average_Tturn", "Average_Ttotal", "mean_latency", "Best_Performance"))

# Define the columns to normalize
cols_to_normalize <- c("Time", "Average_Tturn", "Average_Ttotal", "mean_latency")
